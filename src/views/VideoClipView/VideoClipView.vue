    ...
    >
      <van-swipe-item v-for="(item, index) in swiperList" :key="index">
        <div class="right_menus">
          <div class="menuClick">
            <img class="avatar" :src='item.cove'>
          ...
          <div class="click-info">
            <img class="icon" src="../../assets/imgs/me_ico_comment.png"  @click="goToComments(item.avatar)">
  ...
  data() {
    return {
      ...
      swiperList: [
          ...
          play: false,
          url:
            "http://vodkgeyttp8.vod.126.net/cloudmusic/a12c/mv/51f0/47f3c1c607219822cfcde749a630bddd.mp4?wsSecret=ba61f87fa5cdbf60dba9f41346b7b364&wsTime=1667995413",
          msgInfo:
        ...
        
        {
          ...
          play: false,
          url:
            "http://vodkgeyttp8.vod.126.net/cloudmusic/YCIhISAgMjJgMDAgYCAwIQ==/mv/5876126/44ade06f9cf08c17aa1393928a470f3e.mp4?wsSecret=f3f779ec0b980a0bb02ae485f6657bf1&wsTime=1667995656",
          msgInfo:
            "这是留言这是留言这是留言这是留言这是留言这是留言这是留言这是留言"
        },
        {
          ...
          url:
            "http://vodkgeyttp8.vod.126.net/cloudmusic/9c4a/core/a699/b40e2e9001535da80c5aefc66cf47195.mp4?wsSecret=77617287ab7091dee4d7a110fd548733&wsTime=1667995832",
          msgInfo:
            "这是留言这是留言这是留言这是留言这是留言这是留言这是留言这是留言"
        },
